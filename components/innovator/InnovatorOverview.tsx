...
import { Coins, ShoppingBag, TrendingUp, TrendingDown, Upload, BarChart3, Rocket } from 'lucide-react';
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-gray-900 leading-tight tracking-tight">
            Hey, {profile?.full_name?.split(' ')[0] || 'Innovator'} 👋
          </h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Link href="/subscription">
            <div className="p-4 rounded-xl border border-gray-100 hover:border-[#A7D129]/40 hover:bg-gray-50 transition-all cursor-pointer group">
              ...
              <p className="text-sm font-black text-gray-900">Upgrade</p>
              <p className="text-xs text-[#6A7B92] mt-0.5">Get more features</p>
            </div>
          </Link>
        </div>
      </div>
