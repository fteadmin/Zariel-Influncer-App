...
export function UserProductPurchases() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-64">Loading product purchases...</div>;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">My Product Purchases</h2>
          <p className="text-gray-600 mt-1">Products you've purchased from the marketplace</p>
        </div>
